<div class="clear"> </div>
	...
	<div class="content " >
            ...
            <ul class="meniu-footer menu_slicknav" id="admin_top_menu">
                ...
                <li  {if $action=='admin-users' or $action=='admin-usergroup' } class="active"{/if}><a href="#" >Users</a>
                            ...
                            <ul> 
                                ...
                                <li {if $action=='admin-users'}class="active" {/if}><a href="{$admin_usergroup_actions_url}" >User group Actions</a></li>
                                {/if}
                            </ul>
